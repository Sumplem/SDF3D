...
public:
    ...
    bool drawPopup(SdfGraph& graph, float editorX, float editorY);
    ...
    bool drawPopupFromOutput(SdfGraph& graph, float editorX, float editorY, SdfGraphNodeId fromNode, std::string fromSocket);
    ...
    bool drawPopupToInput(SdfGraph& graph, float editorX, float editorY, SdfGraphNodeId toNode, std::string toSocket);
